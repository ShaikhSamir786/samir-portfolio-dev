  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 z-40 p-4 rounded-full bg-primary text-primary-foreground shadow-lg shadow-primary/30 transition-all duration-300 hover:scale-110 active:scale-95 ${
      ...
      {/* Off-canvas Sidebar */}
      <div 
        className={`fixed top-0 right-0 h-screen w-full sm:w-[400px] bg-background border-l border-white/10 z-50 shadow-2xl flex flex-col transform transition-transform duration-300 ease-in-out ${
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4 scroll-smooth">
        ...
        {isLoading && messages[messages.length - 1]?.role === 'user' && (
          <div className="flex justify-start">
            <div className="max-w-[85%] rounded-2xl px-4 py-3 text-sm bg-white/5 border border-white/10 text-foreground rounded-bl-sm flex items-center gap-2">

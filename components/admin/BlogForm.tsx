    ...
    <form onSubmit={handleSubmit} className="max-w-3xl">
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          className="rounded-xl bg-gray-900 px-6 py-3 text-sm font-medium text-white hover:bg-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >

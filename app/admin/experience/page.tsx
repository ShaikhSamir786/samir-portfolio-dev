      ...
      <div className="flex-1 p-6 md:p-10 overflow-auto">
        ...
        {loading ? (
          ...
          <div className="text-center py-20 border-2 border-dashed border-gray-200 rounded-2xl">
            ...
            <p className="text-sm text-gray-500 mb-6">Add your work history to show on your profile.</p>
            <button
              onClick={addExperience}
          ...
          <div className="w-full space-y-4 pb-32">
            {experiences.map((exp, index) => {
              ...
              return (
                <div key={index} className={`bg-white border transition-all shadow-sm rounded-xl ${isExpanded ? "border-gray-200" : "border-gray-200 hover:border-gray-300"}`}>
                  {/* Header Row */}
                  <div className="flex items-center p-4 gap-4">
                    ...
                    <div className="flex-1 flex items-center gap-4 cursor-pointer" onClick={() => toggleExpand(index)}>
                      {exp.logo_url ? (
                        <img src={exp.logo_url} alt="Logo" className="w-10 h-10 rounded object-cover border border-gray-100 bg-gray-50" />
                      ) : (
                      ...
                      <div>
                        <h3 className="font-medium text-gray-900">{exp.position || "New Role"}</h3>
                        <p className="text-sm text-gray-500">{exp.company_name || "Company"} • {exp.start_date ? new Date(exp.start_date).getFullYear() : "YYYY"} - {exp.is_current ? "Present" : exp.end_date ? new Date(exp.end_date).getFullYear() : "YYYY"}</p>
                      </div>
                    </div>
                  ...
                  {/* Expanded Content */}
                  {isExpanded && (
                    <div className="p-4 border-t border-gray-100 bg-gray-50/50 space-y-5">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div className="space-y-1.5">
                          ...
                          <input
                            ...
                            className="w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-gray-900 outline-none bg-white"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div className="space-y-1.5">
                          <label className="block text-xs font-medium text-gray-700">Pay / Salary</label>
                          <input
                            type="text"
                            value={exp.pay}
                      ...
                      <div className="space-y-1.5">
                        <label className="block text-xs font-medium text-gray-700">Experience Description</label>
                        <TipTapEditor

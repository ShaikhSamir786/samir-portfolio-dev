      ...
      <div className="flex-1 p-6 md:p-10">
        ...
        <div className="max-w-xl">
          ...
          <input
            ...
            className="w-full rounded-lg border border-border-primary px-3.5 py-2.5 text-sm text-foreground placeholder-text-muted outline-none focus:border-border-primary transition-colors"
          />
